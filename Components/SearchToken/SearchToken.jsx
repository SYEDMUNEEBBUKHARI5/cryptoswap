...
const SearchToken = ({openToken, tokens, tokenData}) => {
    ...
    return (
        <div className={Style.SearchToken}>
            <div className={Style.SearchToken_modal}>
                <div className={Style.SearchToken_modal_heading}>
                    <h4>Select a token</h4>
                    <Image src={images.close} alt="close"  width={50} height={50} onClick={()=> openToken(false)} />
                </div>
                <div className={Style.SearchToken_modal_search}>
                    <div className={Style.SearchToken_modal_search_img}>
                        <Image src={images.search} alt="img" width={20}  height={20} />
                    </div>
                    <input type="text" placeholder="Search name and paste the address" />
                </div>
                <div className={Style.SearchToken_modal_tokens}>
                    {coin.map((el, i)=>(
